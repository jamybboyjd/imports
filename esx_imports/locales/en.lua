Locales['en'] = {
  ...
  ['rent_vehicle']            = 'import Dealer - Vehicles for rent',
  ['return_provider_menu']    = 'import Dealer - Return vehicle to provider',
  ...
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'vehicle - import Dealer',
  ...
  ['customer_model']          = 'import model',
  ['customer_plate']          = 'import plate',
